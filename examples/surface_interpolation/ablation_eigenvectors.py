...
for k in [1,2,5,10,100,200,300]:
    ...
    for t in range(trials):
        ...
        #         with laplacian
        # =============================================================================
        train_x, train_f = d.evecs_L[:,:k].reshape(d.n, -1)[train_ind], d.vectors[train_ind]
        test_x, test_f = d.evecs_L[:,:k].reshape(d.n, -1)[test_ind], d.vectors[test_ind]
        ...
        results.append([test_f, f_pred_mean, f_pred_mean_lap])
